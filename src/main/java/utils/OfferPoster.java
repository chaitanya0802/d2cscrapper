...
public class OfferPoster {

    private static final String BACKEND_URL = "https://your-backend.com/api/offers/bulk";
    ...
    public static String getAccessToken(String storename) throws Exception {
        ...
        return json.get("token").asText(); // change "token" if backend uses different key
    }

    // Post JSON array of offers
    public static boolean postOffers(List<Offer> offers, String storename) throws Exception {
        ObjectMapper mapper = new ObjectMapper();
        String jsonBody = mapper.writeValueAsString(offers);
